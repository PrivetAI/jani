...
| **Нежность** | Прогресс-бар -50..+50 с цветовым градиентом |
...
| **Affection** (Нежность) | -50..+50 | Забота, привязанность |
...
Доступные настроения: `joyful`, `sad`, `angry`, `aroused`, `jealous`, `vulnerable`, `playful`, `tender`, `passionate`, `shy`, `curious`, `flirty`, `melancholic`, `neutral`
...
- `chat_sessions` — состояние сессий (last_message_at)
