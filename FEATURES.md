...
Система ежедневного логирования:

- **Формат**: Текстовые файлы `logs/YYYY-MM-DD.log`
- **Содержимое**: INFO, WARN, ERROR, LLM запросы/ответы, все чаты (user/assistant)
- **Отправка**: Ежедневно в 00:05 в Telegram (`BACKUP_CHAT_ID`)
- **Очистка**: Файл удаляется после успешной отправки

**Формат записей:**
```
[2026-01-20T16:52:28.123Z] [CHAT] [U:123 C:5] user: Привет!
[2026-01-20T16:52:30.456Z] [CHAT] [U:123 C:5] assistant: __улыбается__ Привет!
[2026-01-20T16:52:31.789Z] [INFO] Memory added {"content":"любит кофе"}
[2026-01-20T16:52:35.000Z] [ERROR] LLM request failed {"error":"timeout"}
```
